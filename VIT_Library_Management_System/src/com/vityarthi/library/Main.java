...
public class Main extends JFrame {
    ...
    public static void main(String[] args) {
        // 1. Support direct terminal execution (evaluator / headless mode)
        if ((args.length > 0 && args[0].equalsIgnoreCase("--cli")) || GraphicsEnvironment.isHeadless()) {
            System.out.println("[INFO] Terminal Environment Detected. Launching CLI mode...");
            new CLI().start();
            return;
        }
